...
const PRODUCTS = [
  {
    ...
    price: 0.1,
    desc: "Aprenda a organizar suas finanças, economizar e investir de forma prática e simples.",
  ...
  },
  {
    ...
    price: 0.1,
    desc: "Comece a investir do zero com estratégias simples e seguras para iniciantes.",
...
export default function App() {
  ...
  // NOVOS ESTADOS PARA CÓDIGO FIXO
  const [userCode, setUserCode] = useState("");
  const [codeVerified, setCodeVerified] = useState(false);
  const correctCode = "78#34tm12"; // código fixo que você envia para o usuário
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black text-white flex flex-col items-center p-6">
      ...
      <header className="w-full max-w-5xl flex items-center justify-between mb-8">
        ...
        <div className="relative">
          <button
            className="bg-amber-400 text-black px-4 py-2 rounded-lg font-bold"
            onClick={() => setSelected(null)}
          >
            Produtos
          </button>
          <button  
            className="ml-4 bg-green-500 text-black px-4 py-2 rounded-lg font-bold"  
            onClick={openPix}  
          >
            Pix ({cart.length})
          </button>
        ...
        <section className="bg-gray-800 p-6 rounded-xl shadow max-w-4xl w-full mb-8">  
          <div className="flex flex-col md:flex-row gap-6">  
            ...
            <div className="flex-1">  
              ...
              <div className="text-amber-400 font-bold mt-2 text-xl">R${selected.price.toFixed(2)}</div>  
      ...
      {cart.length > 0 && (  
        <section className="bg-gray-900 p-4 rounded-xl shadow w-full max-w-4xl mb-8">  
          ...
          <div className="flex justify-between mt-3 font-bold text-amber-400">  
            Total: R${total}  
          </div>  
        </section>  
      )}  
        ...
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center p-4 z-50">  
          <div className="bg-gray-900 rounded-xl p-6 max-w-md w-full">  
            ...
            <div className="text-center">  
              <div className="mb-3 text-gray-300">Escaneie o QR Code ou copie a chave Pix</div>  
              ...
              <div className="mt-4">  
                ...
                {/* Instruções e campo de código */}
                <p className="text-center text-gray-300 mt-4 mb-2">
                  ...
                  <button
                    ...
                    onClick={() => {
                      if (userCode === correctCode) {
                        ...
                        alert("Código correto! Downloads liberados.");
                      } else {
                  ...
                  <div className="mt-4 flex flex-col gap-2">
                    {cart.map((p) => (
                      <a
                        ...
                        className="bg-green-500 text-black px-5 py-3 rounded-lg font-bold inline-block"
                      >
                        Baixar {p.title}
                      </a>
                    ))}
