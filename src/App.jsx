...
const PRODUCTS = [
  {
    ...
    img: "https://i.imgur.com/abc123.png" // imagem genérica
  },
  {
    id: 2,
    ...
    img: "https://i.imgur.com/def456.png" // imagem genérica
  }
];

export default function App() {
  const [cart, setCart] = useState([]);
  const [selected, setSelected] = useState(null); // produto selecionado para pré-visualização
